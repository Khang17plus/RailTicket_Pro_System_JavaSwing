...
public class KhachHangPanel extends JPanel {
    ...
    public KhachHangPanel() {
        ...
        btnSearch.addActionListener(e -> {
            ...
            if (controller != null) {
                if (!keyword.isEmpty()) {
                    controller.timKiemKhachHang(keyword); 
                } else {
        ...
        JLabel sub = new JLabel("Quản lý thông tin và hồ sơ thành viên hệ thống đường sắt");
    ...
    private void themKhachHang() {
        ...
        JDialog dialog = component.createDinamicForm(
            "Thêm Khách Hàng Mới", 
            "Nhập Thông Tin", 
            "Mã số khách hàng được cấp tự động bởi hệ thống", 
        ...
        btnSave.addActionListener(e -> {
            ...
            if (tenKH.isEmpty() || sdt.isEmpty() || cccd.isEmpty()) {
                JOptionPane.showMessageDialog(dialog, "Vui lòng nhập đủ Họ tên, CCCD và Số điện thoại!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
    ...
    private void suaKhachHang() {
        ...
        String emailCu = tableModel.getValueAt(selectedRow, 4) != null ? tableModel.getValueAt(selectedRow, 4).toString() : "";
        ...
        JDialog dialog = component.createDinamicForm(
            ...
            "Cập nhật thông tin khách hàng hành khách", 
        ...
        btnUpdate.addActionListener(ev -> {
            ...
            if (tenMoi.isEmpty() || sdtMoi.isEmpty() || cccdMoi.isEmpty()) {
                JOptionPane.showMessageDialog(dialog, "Họ tên, CCCD và SĐT không được để trống!", "Lỗi", JOptionPane.WARNING_MESSAGE);
                return;
            }
    ...
    private void traCuuKhachHang() {
        String keyword = JOptionPane.showInputDialog(this, "Nhập CCCD hoặc SĐT cần tìm:");
